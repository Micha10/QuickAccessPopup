...
global lDialogActivateAlreadyRunning := "If the application is already running, activate it instead of launching`n(application must be of the exact same location)" ; new
global lDialogAdd := "Add"
global lDialogAddAmpersand := "&Add"
global lDialogAddEditFavoriteTitle := "~1~ Favorite: ~4~ - ~2~ ~3~" ; changed
global lDialogAddFavoriteSelectTitle := "Add Favorite Type - ~1~" ; new
...
global lDialogChangeHotkeyMouseCheckLButton := "You can't assign the ""Left Mouse Button"" without a modifier`n(like ~1~, ~2~, ~3~ or ~4~ keys)." ; lOptionsMouseCheckLButton renamed, changed
...
global lDialogCopyAmpersand := "C&opy" ; new
...
global lDialogFavoriteFolderLiveLevels := "Number of subfolder levels to include in Live Folder menu" ; new
...
global lDialogFavoriteSelectType := "Select the type of favorite to add.`n`nIn the next window, enter :`n- a name for your favorite`n- a content (depending on the type)`n- various settings (icon, shortcut, etc.)`n`nChoose the new favorite's type and click ""~1~""." ; new
...
global lDialogFavoriteTypesHelp1 := "Create a shortcut to a frequently used ""Folder"".`n`nSet the favorite's menu name, path and various menu options.`n`nWith Live Folder Options you can refresh the content of the menu with the current content of the folder.`n`nIn Advanced settings you can set the window position and file manager options." ; new
...
global lDialogFavoriteTypesHelp2 := "Create a shortcut to a ""Document"".`n`nSet the favorite's menu name, path and various menu options.`n`nAdvanced settings allow you to choose a specific application to launch the document and add optional parameters." ; new
global lDialogFavoriteTypesHelp3 := "Create a shortcut to an ""Application"" (program, script or batch file).`n`nBrowse for the executable file or select one of the currently running programs. Set various menu options.`n`nAdvanced settings allow to select a ""Start In"" directory and add parameters." ; new
...
global lDialogFavoriteTypesHelp5 := "Create a ""Link"" to a web page.`n`nSet menu name, web page's address (URL) and various menu options.`n`nAdvanced settings allow you to select a specific browser to launch the link and add optional parameters." ; new
global lDialogFavoriteTypesHelp6 := "Create a shortcut to an ""FTP Site"".`n`nSet menu name, FTP site's address (URL), login name, password and various menu options.`n`nAdvanced settings allow you to select a specific FTP program to access this site, add optional parameters, set the window position and encode login name and password.`n`nNote: the password is NOT encrypted when sent over Internet." ; new
global lDialogFavoriteTypesHelp7 := "Insert anywhere in your menu ""Quick Access Popup Features"" such as: ~1~`, ~2~, ~3~, ~4~, ~5~, etc.`n`nSee descriptions and help links for more information." ; new
global lDialogFavoriteTypesHelp8 := "Gather related favorites in a ""Submenu"".`n`nGive your submenu a name and select menu options.`n`nAdd favorites to your submenu. Move a favorite to another submenu or group using the ""Move"" button or the ""Menu Options"" tab of the ""Edit favorite"" window." ; new
global lDialogFavoriteTypesHelp9 := "Launch a ""Group"" of favorites, all in one shortcut!`n`nGive your group a name and set various options for your group.`n`nAdd favorites to your group. Move a favorite to another group or submenu using the ""Move"" button or the ""Menu Options"" tab of the ""Edit favorite"" window.`n`nAdvanced settings allow you to control restoring speed by inserting a delay between each favorite to restore." ; new
...
global lDialogFavoriteTypesLocationLabels := "Folder (path)|Document (path and file name)|Application (path and file name)||Link (URL)|FTP Site (URL)|||||||Content|External settings file (path)|Text Separator" ; changed
global lDialogFavoriteTypesShortNames := "Folder|Doc|App|Special|Link|FTP|QAP|Menu|Group|Separator|Column Break|..|Snippet|Shared|Text" ; changed
...
global lDialogHotkeysManageAbout := "~1~ currently active in ~2~"
...
global lDialogHotkeysManageListSeeShortHotkeyNames := "See abbreviated shortcuts names and hotstring options" ; new
...
global lDialogSelectIconJL := "Select in JLicons.dll" ; new
...
global lHelpText23 := "ADD THIS FOLDER OR LINK`n`nTo quickly ADD a new favorite FOLDER or LINK to the popup menu:`n1) Go to a frequently used folder or web page.`n2) Click the QAP hotkey [~1~] or [~2~], and choose ""Add this Folder or Link"".`n3) Give the favorite a short name, click ""Add"", then ""Save"" in the Settings window." ; changed
...
global lHelpText44 := "- Also in ""Options"": choose your preferred language, menu icons size or window colors. Select the number of recent folders to display, add numeric keyboard shortcuts to the folders menu or shortcut reminders. Pin the popup menu at a fix position or remember the Settings window position." ; new
...
global lImpExpExportAmpersand := "&Export" ; new
...
global lImpExpImportAmpersand := "&Import" ; new
...
global lMenuAddThisFolderXpress := "Add this Folder or Link Express" ; new
...
global lOopsErrorIniFileRetry := "If the settings file is on a network drive, try reloading ~1~ when the network drive becomes available." ; new
...
global lOopsExistingHotstring := "This hotstring includes an hotstring for another favorite or is already included an existing hotstring.`n`nSaved: ~1~`nExisting: ~2~"
...
global lOopsFtpLocationProtocol := "FTP location address must start with ""ftp://""." ; new
...
global lOopsOSVerrsionError := "~1~ requires Window 7 or a more recent operating system. Windows Vista and XP users are invited to use Folders Popup which is compatible with these versions.`n`nDo you want to visit Folders Popup website?" ; new
...
global lOptionsAlternativeMenuFeatures := "Alternative Hotkeys" ; new
...
global lOptionsControlDoublePressedLeft := "Using Left Control key" ; new
global lOptionsControlDoublePressedRight := "Using Right Control key" ; new
...
global lOptionsExclusionList := "Exclusions" ; new
...
global lOptionsRecentFolders := "Numb&er of items in menus" ; changed
...
global lTooltipSnippetWaitMacro := "Hit ""~1~"" or ""~2~"" to launch the macro (waiting ~3~ seconds or press ~4~ to cancel)" ; new
global lTooltipSnippetWaitSpace := "Space"
global lTooltipSnippetWaitText := "Select the insertion point and hit ""~1~"" or ""~2~"" to paste the snippet (waiting ~3~ seconds or press ~4~ to cancel)" ; new
