...
global lImpExpAppend := "Append to" ; new
...
global lImpExpFileGlobal := "Global Settings and Popup menus hotkeys" ; new
...
global lImpExpOptionHotkeys := "Hotkeys (Favorites and Alternative menus hotkeys)" ; new
global lImpExpOptions := "~1~ existing ~2~" ; new
global lImpExpReplace := "Replace" ; new
...
global lImpExpReplaceSection := "Replace (OVERWRITE) the content in the existing file?`n`n~1~`n`n[~2~]`n~3~" ; new
global lImpExpFavoritesNotFound := "Favorites not found in the file:`n`n~1~" ; new
global lImpExpCompleted := "Transfer completed.`n`nSource: ~1~`n`nDestination: ~2~" ; new
