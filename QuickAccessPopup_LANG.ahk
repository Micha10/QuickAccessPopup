...
this["DonateButtonAmpersand"] := "Sponsor this &software!"
...
this["DonateCheckPrompt2"] := "Note: Users who kindly make a minimum donation of 5$ or 5€ are given a SPONSOR CODE that will STOP ~1~."
this["DonateCheckPrompt3"] := "display this message"
this["DonateCheckPrompt4"] := "display sponsoring reminders"
this["DonateCheckPrompt5"] := "and insert a sponsor thank you message in the Settings window"
...
this["GuiDonateCodeInput"] := "Enter your sponsor code"
this["GuiDonateCodeInputDescription"] := "Enter the donor code and sponsor name recevied by email after you made a donation to sponsor Quick Access Popup development."
...
this["GuiDonateCodeInputDonorLabel"] := "Enter your DONOR CODE (8-digit code)`n(the value after ""Donor="" in your sponsoring email)"
this["GuiDonateCodeInputSponsorLabel"] := "Enter your SPONSOR NAME`n(the value after ""Sponsor="" in your sponsoring email)"
this["GuiDonateDescription"] := "Display the ""Sponsor this software"" dialog box.`n`nYou can make donation in US $, Euros or CAN $ using Paypal or your credit card. You can also make small monthly donations.`n`nDeveloping this app and supporting its users take a lot of my free time. But I like it and do my best to keep users more efficient and happy. Sponsors help me enhance the app regularly and support users!"
...
this["GuiRemoveFavoriteAmpersand"] := "&Remove"
