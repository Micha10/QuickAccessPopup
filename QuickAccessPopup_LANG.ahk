...
global lDialogChangeHotstringTitle := "Change hotstring - ~1~ ~2~"
...
global lDialogHotkeysManageListHeaderHotstrings := "Trigger|Options"
global lDialogHotkeysManageListSeeAllFavorites := "See all favorites" ; new
global lDialogHotkeysManageListSeeShortHotkeyNames := "See abbreviated hotkey names and hotstring options" ; new
...
global lOopsEnableHotstrings := "Your hotstring has been saved. Before using it, you must select the ""Enable Hotstrings"" checkbox in ""Options"", ""General"" tab."
...
global lOopsHotkeyAlreadyUsed := "The ~1~ ""~2~"" is already used for ""~3~"".`n`nPlease choose another hotkey for ""~4~""."
...
global lOopsInvalidHotstring := "Invalid characters in hotstring (~1~).`n`nValid chars in hotstrings are:`n`nletters (a-z)`nnumbers (0-9)`nand these symbols:`n# $ % & * + < = > @ ^ _ `` | ~`n- ( ) ' : `; "" / , . ? ! [ ] { } \"
...
global lOptionsEnableHotstrings := "Enable Hotstrings"
...
global lTooltipSnippetWaitText := "Select the insertion point and hit ""~1~"" or ""~2~"" to paste the snippet (waiting ~3~ seconds)" ; new
