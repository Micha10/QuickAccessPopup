...
global lDialogFavoriteFolderLiveColumns := "Number of items per column (empty for no column)"
...
global lDialogIconsManage := "Manage Icons"
...
global lOopsMaxLiveFolder := "The maximum number of items in Live folders (~1~) has been exceeded. Please, reduce the number of levels of Live folders.`n`nYou could also raise this limit but be careful: too large number can produce unpredicable result. Edit the value ""NbLiveFolderItemsMax"" under the [Global] section of the settings file (QuickAccessPop.ini)."
...
global lOptionsAddAutoAtBottom := "Add automatically at bottom of menu" ; new
