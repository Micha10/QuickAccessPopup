...
this["DialogMoveSettingsNotDefault"] := "You can not move the Settings Folder when an alternative settings file is loaded.`n`nPlease reload the default settings file and try again."
