...
global lOptionsRunAsAdminAlert := "Warning: Running Quick Access Popup in Administrator mode can result in unexpected consequences when launching programs that may themselves be infected with malicious code. This could allow malicious programs to inherit administrative privileges and infect or take control of your computer. Use caution when running Quick Access Popup in Administrator mode."
