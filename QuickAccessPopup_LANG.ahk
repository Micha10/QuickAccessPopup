...
this["DialogInvalidHotkey"] := "With your current system keyboard layout, the hotkey ""~1~"" could not be used as a trigger for the popup menu (not a valid key name error).`n`nPlease open the ""Customize"" window from the Tray menu and click ""Options"". In this dialog box, choose another shortcut for ""~2~""."
...
this["DialogMouseButtonsTextShort"] := "Left Mouse|Middle Mouse|Right Mouse|Special Mouse 1|Special Mouse 2|Wheel Up|Wheel Down|Wheel Left|Wheel Right|" ; shorten the existing labels by removing the word "Button" or "Mouse", for example. This list will used in menu reminders.
...
this["HelpText22"] := "In the various tabs of the ""Add favorite"" dialog box, enter the ""Basic Settings"", ""Menu Options"", ""Window Options"" and ""Advanced Settings"". Click ""Add"" to insert the favorite in your menu and ""Save"" in the ""Customize"" window."
...
this["HelpText24"] := "The ""Customize"" window is automatically open at QAP startup. When you are satisfied with your menu, you can keep this window closed at QAP startup and open it only when you need to update your menu. Select your preference in ""Options"", section ""Customize Window""."
...
this["HelpText43"] := "- Configure your Quick Access Popup menu triggers: choose your preferred mouse buttons or keyboard shortcuts. In ""Customize"" window, choose the ""Options, Popup Hotkeys"" menu."
this["HelpText44"] := "- Also in ""Options"": choose your preferred language, menu icons size or window colors. Select the number of recent folders to display, add numeric keyboard shortcuts to the folders menu or shortcut reminders. Pin the popup menu at a fix position or remember the ""Customize"" window position. And much more..."
...
this["MenuReloadDescription"] := "Restart Quick Access Popup.`n`nMake sure you save changes in ""Customize"" before restarting QAP."
...
this["MenuSwitchSettingsDescription"] := "Select another QAP settings file and restart Quick Access Popup with these settings (including favorites and various options).`n`nMake sure you save changes in ""Customize"" before restarting QAP."
...
this["OptionsUsageDbShowPopularityIndex"] := "Show frequency index in ""Customize"" and menus"
