...
global lOopsMenuExternalCollaborativeChangedBy := "Changes to this personal shared menu are UNSAVED on computer: ~1~.`n`nIf you save changes to this menu here, unsaved changes on the other computer will be lost and you should cancel these changes when you retrun to the other computer."
global lOopsMenuExternalCollaborativeReservedBy := "This collaborative shared menu is RESERVED by user: ~1~.`n`nWait for this user to release the shared menu or contact your system administrator."
