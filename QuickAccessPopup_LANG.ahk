...
global lDialogFavoriteRemoveExternalPrompt := "Remove the external submenu ""~1~""`n(external settings ini file will NOT be deleted)?" ; new
...
global lDialogFavoriteTypesLabels := "&Folder|&Document|&Application|&Special Folder|&Link|F&TP Site|&QAP Feature|Sub&menu|&Group||||S&nippet|&External Menu" ; changed
...
global lOopsErrorIniFileUnavailable := "This external menu settings file is unavailable" ; new
global lOopsErrorReadingIniFile := "An error occurred while reading this settings file:" ; new
global lOopsExternalMenuReadOnly := "This external menu is in read-only and cannot be modified." ; new
