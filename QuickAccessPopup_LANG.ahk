...
this["AppTagline"] := "<a href=""http://www.quickaccesspopup.com/what-should-i-know-about-quick-access-popup-before-starting/"">Quick Start</a> • <a href=""http://www.quickaccesspopup.com/frequently-asked-questions/"">Frequently asked questions</a> • <a href=""http://www.quickaccesspopup.com"">Support</a>"
...
this["ContextShowMenuAternative"] := "Show Quick Access Popup Alternative menu"
...
this["ControlToolTipColumnBreak"] := "Insert a column break at the current menu position"
...
this["ControlToolTipSearchButton"] := "Search for favorites in the menu"
this["ControlToolTipSeparator"] := "Insert a menu separator at the current menu position"
this["ControlToolTipSortFavorites"] := "Sort all or selected favorites in list"
this["ControlToolTipTextSeparator"] := "Insert a text menu separator at the current menu position"
...
this["DialogAdmnistrator"] := "Administrator"
this["DialogAdmnistratorNot"] := "Not Administrator"
this["DialogAlt"] := "Alt"
...
this["DialogChangeHotkeyKeyReserved"] := "The hotkey ""~1~"" is reserved by Windows."
...
this["DialogCloseComputerIntro"] := "Select the action to execute"
...
this["DialogCloseComputerStartScreenSaver"] := "St&art screen saver"
this["DialogCloseComputerStartScreenSaverDescription"] := "Start default system screen saver."
this["DialogCloseComputerSuspend"] := "S&leep computer"
...
this["DialogContinueAmpersand"] := "C&ontinue"
this["DialogCopy"] := "Copy"
this["DialogCopyAmpersand"] := "C&opy"
...
this["DialogExternalAddFromCatalogue"] := "Do you want to add an external menu from the Shared Menus Catalogue?"
...
this["DialogFavoriteTypesLabels"] := "&Folder|&Document|&Application|&Special Folder|&Link (URL)|F&TP Site|&QAP Feature|Sub&menu|&Group||||S&nippet|S&hared Menu|Text Separator|&Windows App"
this["DialogFavoriteTypesLabelsNoAmpersand"] := "Folder|Document|Application|Special Folder|Link (URL)|FTP Site|QAP Feature|Submenu|Group||||Snippet|Shared Menu|Text Separator|Windows App"
...
this["DialogHotstringsShort"] := "Hotstrings" ; max 12 chars
...
this["DialogHotstringWaitEndingKey"] := "Wait ending key"
...
this["DialogMoreOptions"] := "More options"
...
this["DialogMoveSettingsToMyDocumentsInfo"] := "You can keep your settings in their current location if you prefer. You will also be able to select another location in ""Options"", ""General"" tab."
this["DialogMoveSettingsToMyDocumentsOverwrite"] := "The content in the destination folder will be OVERWRITTEN."
this["DialogMoveSettingsToMyDocumentsQuestion"] := "Since v10, ~1~ stores its settings under a ""My Documents"" folder. This makes it easier to backup settings. Do you want to move your setting?`n`nFrom:`n~2~`nTo:`n~3~"
this["DialogMoveSettingsToMyDocumentsReload"] := "~1~ needs to be restarted..."
this["DialogNA"] := "n/a"
this["DialogNone"] := "None"
this["DialogNormal"] := "Normal"
this["DialogOff"] := "Off"
this["DialogOK"] := "OK"
this["DialogOKAmpersand"] := "&OK"
this["DialogOn"] := "On"
...
this["DialogOr"] := "or"
this["DialogOtherHotkeys"] := "Other hotkeys for main menu"
...
this["DialogSelectItemToAdd"] := "Select the item to add"
...
this["DialogSwitchSettingsCancel"] := "Switch Settings file canceled...`n`nCurrent settings file: ~1~"
this["DialogSwitchSettingsReady"] := "Reload ~2~ with new Settings file:`n`n~1~"
...
this["DonateButtonAmpersand"] := "Sponsor this &Freeware!"
this["DonateCheckPrompt"] := "Welcome to this new release of ~1~?`n`n~1~ is not only FREE of charge but also FREE of nasty advertising or adware that you never know if they carry spyware or malware.`n`n~2~ times so far, ~1~ has helped you in your daily work. How about sponsoring this freeware now?"
this["DonateCheckPrompt2"] := "Note: Users who kindly make a donation are given a SPONSOR CODE that will STOP ~1~."
...
this["DonateMenu"] := "Sponsor this Freeware!"
...
this["DonateText2"] := "<a href=""~1~"">Why sponsor this freeware?</a>"
this["DonateText3"] := "... or support this freeware for free!"
this["DonateText4"] := "Give a favorable review to ~1~ on:"
this["DonateText5"] := "Send me your link"
this["DonateThankyou"] := "Thank you ~1~ for sponsoring this freeware!"
this["DonateTitle"] := "Sponsor this freeware! - ~1~ ~2~"
...
this["GuiCancelAmpersand"] := "&Cancel"
this["GuiClose"] := "Close"
this["GuiCloseAmpersand"] := "&Close"
this["GuiCopyAmpersand"] := "C&opy"
this["GuiDonate"] := "Sponsor this freeware"
this["GuiDonateDescription"] := "Display the ""Sponsor this Freeware"" dialog box.`n`nYou can make donation in US $, Euros or CAN $ using Paypal or your credit card. You can also make small monthly donations.`n`nDeveloping this app and supporting its users take a lot of my free time. But I like it and do my best to keep users more efficient and happy. Sponsors help me enhance the app regularly and support users!"
...
this["GuiMove"] := "Move"
this["GuiMoveAmpersand"] := "&Move"
this["GuiOptions"] := "Options"
this["GuiOptionsDescription"] := "Display the ""Options"" dialog box allowing to make QAP work the way you want.`n`nThe options are grouped in tabs: ""General"", ""Menu"", ""Hotkeys"", ""Alternative hotkeys"", ""File managers"" and ""More"" for other options."
...
this["GuiSaveAmpersand"] := "&Save"
this["GuiSaveAndCloseAmpersand"] := "&Save && Close"
this["GuiSaveAndStayAmpersand"] := "Save"
...
this["HelpText12"] := "When you select a favorite FOLDER in Windows Explorer or a file dialog box*, Quick Access Popup  instantly ""navigate"" the current window to this folder! * This feature must be enabled in Options."
...
this["HelpText22"] := "In the four tabs of the ""Add favorite"" dialog box, enter the ""Basic Settings"", ""Menu Options"", ""Window Options"" and ""Advanced Settings"". Click ""Add"" to insert the favorite in your menu and ""Save"" in the Settings window."
...
this["HelpText43"] := "- Configure your Quick Access Popup menu triggers: choose your preferred mouse buttons or keyboard shortcuts in ""Settings, Options, Menu hotkeys""."
this["HelpText44"] := "- Also in ""Options"": choose your preferred language, menu icons size or window colors. Select the number of recent folders to display, add numeric keyboard shortcuts to the folders menu or shortcut reminders. Pin the popup menu at a fix position or remember the Settings window position."
...
this["ImpExpExportAmpersand"] := "&Export"
this["ImpExpFavorites"] := "favorites"
this["ImpExpFavoritesNotFound"] := "Favorites not found in the file:`n`n~1~"
...
this["ImpExpHotkeys"] := "hotkeys"
this["ImpExpImport"] := "Import"
this["ImpExpImportAmpersand"] := "&Import"
...
this["ImpExpUnsavedSettings"] := "A settings window is open, possibly with unsaved changes.`n`nPlease close the settings windows before importing or exporting settings."
this["MainMenuName"] := "Main"
this["MenuAboutAmpersand"] := "A&bout"
...
this["MenuFavorite"] := "F&avorite"
this["MenuFavoritesInternet"] := "Favorites (Internet)"
this["MenuFile"] := "&File"
...
this["MenuRestoreEditCopyMoveWindowPosition"] := "Restore dialog boxes window position"
this["MenuRestoreEditCopyMoveWindowPositionDescription"] := "Restore the Edit, Copy and Move dialog boxes position to the center of the main screen."
...
this["MenuRunAtStartupAmpersand"] := "&Run at Startup"
...
this["MenuSettingsFileOptions"] := "Settings file options"
...
this["MenuUpdateAmpersand"] := "Check for &update"
this["MenuUpdateNoAmpersand"] := "Check for update"
this["MenuUpdateNoAmpersandDescription"] := "Check on Quick Access Popup web site if a new version is available."
this["MenuUserFolder"] := "User Folder"
this["MenuUserPinned"] := "User Pinned"
this["MenuWebSiteSupport"] := "QAP Support Forum"
...
this["OopsExternalCatalogueReadOnly"] := "The Shared Menus Catalogue option is read-only. Please contact your system administrator."
...
this["OopsLocation"] := "location"
this["OopsMaxLiveFolder"] := "The maximum number of items in Live folders (~1~) has been exceeded. Please reduce the number of levels of Live folders.`n`nYou could also raise this limit but be careful: a too-large number can produce unpredicable results. Change the value in ""Options, Advanced Options, Menu Advanced Options""."
...
this["OopsOptionsPathBackup"] := "Backup folder"
this["OopsOptionsPathNotExist"] := "~1~ does not exist:`n~2~`n`nPlease, select a valid path."
this["OopsOptionsPathTemp"] := "Temporary folder"
this["OopsOptionsPathTrayIcon"] := "Tray icon file"
this["OopsOptionsPathWorking"] := "Working folder"
...
this["OopsQAPfeature"] := "QAP feature"
this["OopsRestoreEditCopyMoveWindowPosition"] := "Restore Edit, Copy and Move dialog boxes window position?"
...
this["OopsWorkingFolderMissing"] := "The ~1~ settings folder does not exist:`n`n~2~`n`nPlease make sure the drive containing this folder is online or re-install ~1~."
...
this["OptionsAlternativeMenuOptions"] := "Alternative Menu Options"
...
this["OptionsCatalogueHelp"] := "Shared Menu Catalogue (<a href=""~1~"">~2~</a>)"
...
this["OptionsClipboardMaxSize"] := "Do not refresh the ""Clipboard"" menu if it's size is greater than (default 10000 bytes):"
...
this["OptionsExplorerContextMenusHeader"] := "Windows Explorer Context Menus"
...
this["OptionsHotkeyRemindersFull"] := "Display f&ull hotkey and hotstring"
this["OptionsHotkeyRemindersNo"] := "Do not di&splay"
this["OptionsHotkeyRemindersPrompt"] := "Hotkey and Hotstring reminders in menu:"
this["OptionsHotkeyRemindersShort"] := "Display a&bbreviated"
...
this["OptionsIconReplacementListDescription"] := "Replacement for default icons found in JLicons.dll"
...
this["OptionsMenuFixPosition"] := "At a fi&x position"
this["OptionsMenuIcons"] := "Menu Icons"
this["OptionsMenuNearMouse"] := "Near the mouse &pointer"
this["OptionsMenuOptions"] := "Menu"
this["OptionsMenuPositionPrompt"] := "Popup the menu:"
this["OptionsMoreOptions"] := "Advanced Options"
this["OptionsMouseAndKeyboard"] := "Hotkeys"
this["OptionsMoveWorkingFolderType"] := "Do you want to copy your current settings to this new location:`n`n~1~`n`nIf you select YES, ~2~ will be reloaded with your current settings copied in the new location.`n`nIf you select NO, ~2~ will be reloaded with the settings already found (or created) in this new location."
this["OptionsNbLiveFolderItemsMax"] := "Maximum number of items in Live folders (default 500):"
...
this["OptionsPopupHotkeysOther"] := "Other Popup Hotkeys Options"
...
this["OptionsRecentFolders"] := "Numb&er of items in menus"
...
this["OptionsRunAsAdminExit"] := "~1~ will be launched without administrative right next time you launch it.`n`nDo you want to exit ~1~ now? Unsaved changes to the menu will be lost."
...
this["OptionsSendToConsoleWithAlt"] := "Use ASCII codes (ALT+0nnn) when changing folder in Window Command Line (CMD)"
...
this["OptionsSwitchExclusionListDescription"] := "Exclusions list for applications found in the ""Current Windows"" menu."
...
this["OptionsTabMenuOptionsIntro"] := "Make the popup menu appear as you like !"
this["OptionsTabMouseAndKeyboardIntro"] := "Define the mouse buttons and keyboard hotkeys that will trigger the ~1~ main menu."
this["OptionsTabOtherOptionsIntro"] := "Make ~1~ work the way you like!"
...
this["OptionsUsageDbDescription"] := "Set parameters for ~1~ database"
...
this["OptionsUserVariablesListDescription"] := "Pieces of text that can be inserted as placeholders, e.g.: {MyVariable}"
...
this["OptionsWaitDelayInDialogBox"] := "Delay (in ms) when changing folder in dialog boxes (helps in some apps):"
...
this["SponsoredNone"] := "Thanks for sponsoring this software here"
