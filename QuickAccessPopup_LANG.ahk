...
this["DialogUnavailableWithLiveFolders"] := "(Unavailable with Live Folders)"
...
this["DonateButtonAmpersand"] := "Support &Freeware!"
this["DonateCheckPrompt"] := "Are you happy with ~1~?`n`n~1~ is not only FREE of charge but also FREE of nasty advertising or adware that you never know if they carry spyware or malware.`n`n~2~ times so far, ~1~ has helped you in your daily work. How about supporting freeware now?"
this["DonateCheckPrompt2"] := "Note: Users who kindly make a donation are given a CODE that will STOP ~1~."
this["DonateCheckPrompt3"] := "display this message"
this["DonateCheckPrompt4"] := "display donation reminders"
this["DonateCheckTitle"] := "~1~ times! - ~2~"
this["DonateMenu"] := "Support Freeware!"
this["DonatePlatformComment1"] := "Donate with credit card (no need for an account) or your PayPal account"
this["DonatePlatformComment2"] := "For European donors"
this["DonatePlatformComment3"] := "For Canadian donors"
...
this["DonateText1"] := "Support ~1~ development!"
this["DonateText2"] := "<a href=""~1~"">Why support freeware?</a>"
this["DonateText3"] := "... or support freeware for free!"
this["DonateText4"] := "Give a favorable review to ~1~ on:"
this["DonateText5"] := "Send me your link"
this["DonateThankyou"] := "Thank you for supporting freeware!"
this["DonateTitle"] := "Support freeware! - ~1~ ~2~"
...
this["GuiSaveAndCloseAmpersand"] := "&Save`n&& Close"
this["GuiSaveAndStayAmpersand"] := "Save`n&& &Reload"
this["GuiSaveToUpdateBacklinks"] := "Save to update back links"
...
this["MenuNoClipboard"] := "Clipboard contains no path or URL..."
...
this["MenuPopularMenus"] := "Frequent ~1~"
...
this["OopsChangeFolderInDialogAlert"] := "Did you want to change folder in this dialog box? In order to navigate inside a dialog box, you have to enable an option (first checkbox in the ""General"" tab).`n`nDo you want to open the Options window?"
...
this["OopsMaxLiveFolder"] := "The maximum number of items in Live folders (~1~) has been exceeded. Please reduce the number of levels of Live folders.`n`nYou could also raise this limit but be careful: a too-large number can produce unpredicable results. Edit the value ""NbLiveFolderItemsMax"" under the [Global] section of the settings file (QuickAccessPop.ini)."
...
this["OptionsPopupHotkeysAlternative"] := "Alternative Menu Features Hotkeys"
...
this["OptionsRunAsAdminChanged"] := "New ""Run as administrator"" setting saved. Relaunch ~1~ to enable the new setting."
...
this["OptionsUsageDb"] := "~1~ Database"
...
this["OptionsUsageDbStatement"] := "Privacy Statement: The data in the ~1~ database is collected and stored locally, solely to build dynamic menus and increase performance. This data resides ONLY on your computer and NO information is transmitted to a remote server."
