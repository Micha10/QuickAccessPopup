...
global lOopsErrorIniFileUnavailable := "This external menu settings file is unavailable:`n`n~1~`n`nIf the settings file is on a network drive, try reload ~2~ when the network drive will be available." ; new
