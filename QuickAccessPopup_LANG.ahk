...
global lDialogChangeHotkeyNote := "Note: All favorites named ""~2~"" with location ""~1~"" will be linked to the new hotkey." ; new
global lDialogChangeHotkeyNoteSnippet := "Note: Any snippet named ""~1~"" with the same content will be linked to the new hotkey." ; new
...
global lDialogHotkeysManageListHeader := "Menu|Favorite Name|Type|Hotkey|Favorite Location"
